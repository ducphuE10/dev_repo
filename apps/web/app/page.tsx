    ...
    return (
      <div className="page-stack">
        <section className="hero-panel">
          ...
          <h1>The browse layer for honest dupes with proof, pricing, and real creator taste.</h1>
          <p className="hero-panel__lede">
            Browse is temporarily degraded while Dupe Hunt reconnects to live community data.
          </p>
          <SearchForm />
        </section>
        <DownloadAppBanner />
        <EmptyState
          description="The homepage could not load live feeds right now. Retry in a moment or jump straight into search."
          title="Browse is temporarily unavailable"
        />
      </div>
    );
  }
