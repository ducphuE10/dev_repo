    ...
    return (
      <div className="page-stack">
        <section className="hero-panel hero-panel--compact">
          <p className="eyebrow">Search the community</p>
          <h1>Find dupes by product name, brand, category, or what everyone keeps typing.</h1>
          <p className="hero-panel__lede">Search is temporarily running without live results while the API reconnects.</p>
          <SearchForm
            initialCategory={category}
            initialQuery={query}
            initialSort={sort === "newest" ? "newest" : "upvotes"}
        ...
        <DownloadAppBanner />
        <EmptyState
          description="Search results could not load right now. Retry in a moment or browse from the homepage."
